 ...
 */
var classUnselected = "lz";
var classSelected = "pj-S";
var classScrollDiv = "Hh";
//var classHideNotification = "Yt"; DEPRECATED
var blockedCircleId = 15;

//var domCircleUser = ".vi"; DEPRECATED
//var domCircleName = ".ic-X"; DEPRECATED
...
//	}
	$.ajax({
		...
		success: function(data) {
			...
			this_pattern2 = /"plus.google.com",["[0-9]+"]/gm;
			gplustoken = this_pattern.exec(data);
			myId = this_pattern2.exec(data);
			
			
			if (myId)	{
				myId = myId[0];
				myId = myId.replace(/"plus.google.com",\["/g,'');
				myId = myId.replace(/"\]/g,'');
				callback();
			}
